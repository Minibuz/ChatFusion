...
public class FusionChangeLeaderWriter implements Writer {

    private final ByteBuffer bufferOut;

    public FusionChangeLeaderWriter(int bufferSize, InetSocketAddress socketAddress) {
        ...
        bufferOut.put(OpCode.FUSION_CHANGE_LEADER.getValue())
                .put(type)
